...
import { queryJobs } from './actions/job.action'
  ...
  return (
    <main className='flex flex-col'>
      <div className='w-full relative border-b px-12 py-20 text-2xl hover:bg-white/5'>
        ...
        <span className='text-white font-bold'>Effortless job management. </span>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 auto-cols-auto'>
        {loading &&
          ...
          Array(2)
            ...
            .map((Suspense, i) => (
              <div className={i % 2 ? 'border-b' : 'md:border-r border-b'} key={i}>
                <Suspense />
              </div>
            ))}
        {jobs.length ? (
